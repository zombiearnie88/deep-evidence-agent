...
def _apply_actions(
    *,
    ...
    draft_create_update: Callable[
        [SummaryStageResult, PagePlanItem, bool, str], Awaitable[RenderModelT]
    ],
        ...
        for materialized in materialized_docs:
            ...
            _apply_actions(
                ...
                draft_create_update=(
                    ...
                    is_update,
                    existing_body,
                    doc_name=materialized.document.name: _draft_topic_page(
                        model=model,
                        language=language,
                ...
                render_markdown=lambda model_out: _render_topic_page(model_out),
            )
        ...
        for materialized in materialized_docs:
            ...
            touched = _apply_actions(
                ...
                draft_create_update=(
                    ...
                    is_update,
                    existing_body,
                    doc_name=materialized.document.name: _draft_regulation_page(
                        model=model,
                        language=language,
                        document_name=doc_name,
                        summary=summary,
                ...
                render_markdown=lambda model_out: _render_regulation_page(model_out),
            )
        ...
        for materialized in materialized_docs:
            ...
            touched = _apply_actions(
                ...
                draft_create_update=(
                    ...
                    is_update,
                    existing_body,
                    doc_name=materialized.document.name: _draft_procedure_page(
                        model=model,
                        language=language,
                        document_name=doc_name,
                        summary=summary,
                ...
                render_markdown=lambda model_out: _render_procedure_page(model_out),
            )
        ...
        for materialized in materialized_docs:
            ...
            touched_conflicts = _apply_actions(
                ...
                draft_create_update=(
                    ...
                    is_update,
                    existing_body,
                    doc_name=materialized.document.name: _draft_conflict_page(
                        model=model,
                        language=language,
                        document_name=doc_name,
                        summary=summary,
                ...
                render_markdown=lambda model_out: _render_conflict_page(model_out),
            )
